...
describe('ConfigParser object', function () {
    ...
    it('should return every key in a section', function () {
        ...
        expect(config.keys('im running out of ideas')).to.deep.equal(['anotherthing', 'otherthing', 'multiple']);
    });
    ...
    it('should read multiline values', function () {
        expect(config.get('im running out of ideas', 'multiple')).to.equal('lines\nshould work\nif indented');
    });
